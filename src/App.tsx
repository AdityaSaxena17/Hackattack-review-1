...
function App() {
  ...
  const [wcfs,setWcfs] = useState<Record<string, FileNode>>({});
...
// };
            ...
            "children": [
              {
                ...
                "children": [
                  {
                    "id": "file-src/components/TodoList.jsx",
                    "name": "TodoList.jsx",
                    "type": "file",
                  ...
                  {
                    "id": "file-src/components/TodoItem.jsx",
                    "name": "TodoItem.jsx",
                    "type": "file",
                  ...
                  {
                    "id": "file-src/components/TodoForm.jsx",
                    "name": "TodoForm.jsx",
                    "type": "file",
    ...
    async function init() {
      ...
      try {
        ...
        setWcfs(convertToWebContainerFormat(files));
        const localWcfs = convertToWebContainerFormat(files);
     console.log("filetree", files);
     console.log("files to mount", localWcfs);
        await instance.mount(localWcfs);
